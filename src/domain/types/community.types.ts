...
export type FetchAllCommunityInput = Omit<PaginationQuery<ICommunity>, "sort">;
...
export interface FetchAllCommunitiesForUsersInput
  extends Omit<PaginationQuery<ICommunity>, "sort"> {
...
export interface PostDetailsResponse
  extends Omit<ICommunityPostResponse, "comments"> {
  likes: ILike;
  comments: IComment[];
...
export interface CommunityMembersOutput
  extends Omit<ICommunityMember, "userId"> {
  userId: {
    _id: string;
    name: string;
    profileImage: string;
