...
export class ClientRoute extends BaseRoute {
    ...
    protected initializeRoutes(): void {
        ...
        this.router.get('/client/wallet',verifyAuth,authorizeRole(["client"]),(req : Request , res : Response)=> {
