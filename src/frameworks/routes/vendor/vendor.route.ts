...
import { createServiceController, createWorkSampleController, deleteWorkSampleController, getAllBookingForVendorController, getAllPaginatedServiceController, getAllPaginatedWorkSample, getAllVendorCategoriesController, getAllVendorNotificationController, getVendorDetialsController, getWalletDetailsOfUserController, joinCategoryRequestController, logoutController, refreshTokenController, updateBookingStatusController, updateServiceController, updateVendorController, updateWorkSampleController } from "../../di/resolver";
...
export class VendorRoute extends BaseRoute {
    ...
    protected initializeRoutes(): void {
        ...
        this.router.get('/vendor/wallet',verifyAuth,authorizeRole(["vendor"]),(req : Request , res : Response)=>{
